@extends('layouts.app')
@section('title',"Cargar ".ucfirst(config('settings.file_label_plural')))
@section('css')
    <style>
...
@section('content')
    <section class="content-header">
        <h1>
            Cargar {{ucfirst(config('settings.file_label_plural'))}} - <small>{{$document->name}}</small>
    ...
    <div class="content">
        ...
        <div style="text-align: center">
            ...
            <button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-save"></i> Cargar</button>
        </div>
        {!! Form::close() !!}
    </div>
@endsection
