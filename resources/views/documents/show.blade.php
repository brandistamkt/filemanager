@extends('layouts.app')
@section('title',"Ver ".ucfirst(config('settings.document_label_singular')))
@section('css')
    <style>
        .box.custom-box {
                            ...
                            <div class="form-group">
                                <a href="{{\Illuminate\Support\Str::finish(route('files.showfile',['dir'=>'original']),"/")}}@{{file}}?force=true"
                                   download class="btn btn-primary"><i
                                        class="fa fa-download"></i> Descargar original
                                </a>
                            </div>
                            <div class="form-group">
                                <label>{{ucfirst(config('settings.file_label_singular'))." Tipo"}}</label>
                                <p>@{{file_type.name}}</p>
                            </div>
                            <div class="form-group">
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="box box-primary">
                    <div class="box-body">
                        <div class="form-group">
                            <label>{{ucfirst(config('settings.document_label_singular'))}} Nombre:</label>
                            <p>{{$document->name}}</p>
                        </div>
                        <div class="form-group">
            ...
            <div class="col-sm-9">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        @endcan
                        <li class=""><a href="#tab_activity" data-toggle="tab" aria-expanded="false">Actividad</a></li>
                                                ...
                                                <div class="pull-right box-tools">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="javascript:void(0);"
                                                               onclick="showFileModal({{json_encode($file)}})">Ver
                                                                Detalle</a></li>
                                                        <li>
                            ...
                            @can('update', [$document, $document->tags->pluck('id')])
                                <a href="{{route('documents.files.create',$document->id)}}"
                                   class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>
                                    Agregar {{ucfirst(config('settings.file_label_plural'))}}</a>
                            @endcan
                        </div>
                        @can('verify', $document)
                            ...
                            <div class="tab-pane" id="tab_permissions">
                                <div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Dar Permisos</h4>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                        ...
                                        <tr>
                                            <th colspan="3" style="font-size: 1.8rem;">
                                                ...
                                                <button type="button" class="btn btn-primary btn-xs pull-right" data-toggle="modal"
                                                    ...
                                                    <i class="fa fa-plus"></i> Nuevo Permisos
                                                </button>
                                            </th>
                                        </tr>
                                        <tr>
                                    ...
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th colspan="3" style="font-size: 1.8rem;">Permisos heredados
                                    ...
                                    <table class="table">
                                        <thead>
                                        <tr>
                                            <th colspan="3" style="font-size: 1.8rem;">Permisos globales por {{config('settings.document_label_plural')}}</th>
                                        </tr>
                                        <tr>
                                            <th>Usuario</th>
                                            <th>Permisos</th>
