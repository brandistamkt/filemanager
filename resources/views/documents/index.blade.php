@extends('layouts.app')
@section('title',ucfirst(config('settings.document_label_plural'))." Lista")
@section('css')
    <style type="text/css">
        .bg-folder-shaper {
            width: 100%;
        ...
        <div class="box box-primary">
            <div class="box-header">
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('search',null,['class'=>'form-control input-sm','placeholder'=>'Buscar...']) !!}
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control select2 input-sm" name="tags[]" id="tags"
                            data-placeholder="Buscar {{config('settings.tags_label_singular')}}" multiple>
                        @foreach($tags as $tag)
