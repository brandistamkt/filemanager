        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="info-box bg-yellow">
                    ...
                    Total {{ucfirst(config('settings.tags_label_plural'))}} en el sistema
                  </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <div class="info-box bg-green">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="progress-description">
                    Conteniendo {{$filesCounts}} {{ucfirst(config('settings.file_label_plural'))}}
                  </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                        ...
                        <div class="box-tools pull-right">
                            {!! Form::open(['method' => 'get','style'=>'display:inline;']) !!}
                                ...
                                <button type="button" id="activityrange" class="btn btn-default btn-sm">
                                    ...
                                    <span>Elegir Fecha</span> <i class="fa fa-caret-down"></i>
                                </button>
