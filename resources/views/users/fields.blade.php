    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="form-group col-sm-12 col-lg-12 {{ $errors->has('description') ? 'has-error' :'' }}">
                {!! Form::label('description', 'Descripcion(Informacion Adicional):') !!}
...
@can('user manage permission')
                            ...
                            @foreach(config('constants.GLOBAL_PERMISSIONS.USERS') as $permission_name=>$permission_label)
                                <div class="form-group">
                                    <label>
                                        ...
                                        &nbsp;{{ucfirst($permission_label)}} Usuario
                                    </label>
                                </div>
                            @endforeach
                        </div>
    ...
    <div class="box box-primary">
        <div class="box-header no-border">
            <h3 class="box-title">Permisos por {{ucfirst(config('settings.tags_label_plural'))}}</h3>
            <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                </button>
            </div>
