            ...
            <div class="col-sm-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li class=""><a href="#ch_pwd" data-toggle="tab" aria-expanded="false">Cambiar Contraeña</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="profile">
                            ...
                            <div class="form-group {{$errors->has('email')?'has-error':''}}">
                                {!! Form::label('email', 'Correo:', ['class' => 'control-label col-sm-2']) !!}
                                <div class="col-sm-8">
                            ...
                            <div class="form-group {{$errors->has('description')?'has-error':''}}">
                                {!! Form::label('description', 'Descripcion(Informacion Adicional):', ['class' => 'control-label col-sm-2']) !!}
                                <div class="col-sm-10">
                        ...
                        <div class="tab-pane" id="ch_pwd">
                            ...
                            <div class="form-group {{$errors->has('new_password')?'has-error':''}}">
                                {!! Form::label('new_password', 'Nueva Contraseña:', ['class' => 'control-label col-sm-2']) !!}
                                <div class="col-sm-8">
